...
- Read this post for an engineer's perspective on an approach to building software that parallels almost precisely the approach we take in Phase 4: [How we use "ship small" to rapidly build new features at GitHub](https://dev.to/mscccc/how-we-use-ship-small-to-rapidly-build-new-features-at-github-5cl9)
- 🕛 BY NOON: [Make sure you have filled out this survey](https://forms.gle/FPktj9eLLugeuEeu8) about your interests and intentions for Phase 4.
-  [Are you a Chaos Muppet or an Order Muppet? Read this post and **tell us in Slack which one you are**.](https://slate.com/human-interest/2012/06/chaos-theory.html)

## ✅ TODO this afternoon

- **Create a Slack channel** (not a thread) and add team members and instructors to it.
- **Create a team charter** with your team and post it in your team's Slack channel. Please pin or bookmark it. There are resources below to help you with this task.
...
- [Cuckoo](https://cuckoo.team/) The one we use in class ⏲️
...
- ⭐ [Common Time Management Problems & Solutions](https://dev.to/actitime/20-most-common-time-management-problems-solutions-3abb) The top three might sound familiar:
